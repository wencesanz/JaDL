...
function setMeta(route) {
  ...
  let desc = "A slow, curated index of design studios and independent practices.";
  if (d.totals && d.totals.studios) {
    desc += ` ${d.totals.studios} entries across ${d.totals.countries} countries.`;
  }
  let image = null;
  let robots = null;
  let jsonld = [];
